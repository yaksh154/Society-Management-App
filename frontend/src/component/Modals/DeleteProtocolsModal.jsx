...
import { Delete_Security_Protocols } from '../services/Api/api';

const DeleteProtocolsModal = ({_id,CloseDeleteProtocols,Fdata}) => {
    const deletedata = () => {
        Delete_Security_Protocols(_id,Fdata);
    }
    return (
        <div
            className='fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50'
            onClick={(e) => { if (e.target === e.currentTarget) CloseDeleteProtocols() }}>
...
export default DeleteProtocolsModal
