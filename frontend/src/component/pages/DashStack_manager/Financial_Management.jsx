...
const Financial_Management = () => {
  ...
  <button 
    className="px-4 py-2 w-full sm:w-auto text-center bg-orange-500 text-white rounded-t-lg font-semibold focus:outline-none hover:bg-orange-600 transition-colors duration-200"
  >
    Maintenance
  </button>
  
  <Link 
    to="/financial_management/otherincome" 
    className="px-4 py-2 w-full sm:w-auto text-center bg-gray-200 text-gray-700 rounded-t-lg font-semibold focus:outline-none hover:bg-gray-300 transition-colors duration-200"
  >
    Other Income
  </Link>
</div>
