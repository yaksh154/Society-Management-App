...
const ShowMaintenanceDetails = (props) => {
    return (
        <div className={`flex relative lg:items-center md:items-center justify-between p-4 bg-white rounded-lg shadow-md border border-gray-200 max-w-sm max-[425px]:flex-col-reverse max-[425px]:content-start ${props.Addclass}`}>
